import { ComponentContainerDeploymentService } from "src/models/component_container_deployment_service";
 ...
 */
export function generateServiceSection(service: ComponentContainerDeploymentService): string {
