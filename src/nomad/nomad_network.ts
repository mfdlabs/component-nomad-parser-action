import { ComponentContainerDeploymentNetwork } from "src/models/component_container_deployment_network";
 ...
 */
export function generateNetworkSection(network: ComponentContainerDeploymentNetwork): string {
